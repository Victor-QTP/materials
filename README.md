...
- **Independent Deployment:** standalone C++-based ONNX Runtime CUDA/FP16 inference pipeline for YOLOv8 models, with image, camera, RTSP and local video inputs. ([Section 7](#7-independent-c-deployment-onnx-runtime-cudafp16))
...
7. [Independent C++ Deployment: ONNX Runtime CUDA/FP16](#7-independent-c-deployment-onnx-runtime-cudafp16)
8. [Awards & Certificates](#8-awards--certificates)
9. [Prior Projects](#9-prior-projects)
...
*mAP@[0.50:0.95], LoRA-tuned on BDD100K-train first 10,000 images and evaluated on BDD100K validation set.*
...
---
## 7. Independent C++ Deployment: ONNX Runtime CUDA/FP16

- [Section README](cpp_onnx_camera/README.md)

*Ongoing independent C++ deployment work, started after the collaborative research project funded by Taiwan’s National Science and Technology Council (NSTC) concluded.*

After the collaborative project ended, I continued the deployment work independently as a standalone inference project. This specific runtime executes detection models through **ONNX Runtime with the CUDA Execution Provider and FLOAT16 input/output tensors**, and supports image batches, local cameras, RTSP streams and local video files.
